...
<head>
	...
	<style type="text/css" id="illdy-about-section-css">#header.header-front-page {background-image: url(images/landscape.jpg) !important;}#header.header-front-page .bottom-header .header-button-one {background-color: rgba( 0, 0, 0, .4 );}#header.header-front-page .bottom-header .header-button-one:hover {background-color: rgba( 0, 0, 0, .1 );}#header.header-front-page .bottom-header h1 {color: #ffffff;}#header.header-front-page .bottom-header .section-description {color: #ffffff;}</style>

</head>
<body>
	<header id="header" class="header-front-page" style ="backgroung-image:url(images/landscape.jpg); background-attachment:fixed;">
							...
							<div class="col-sm-12">
								<h1>Voyager<span class="span-dot">.</span>Rêver<span class="span-dot">.</span> En toute simplicité </h1>
										...
										<div class="col-sm-8 col-sm-offset-2">
													<div class="section-description">SmoothyTrip est une toute jeune entreprise dont le but est de promouvoir le voyage sur mesure. Avec beaucoup, ou peu d'argent, une multitude d'envies ou juste le besoin de chiller sur une petite plage. Nous trouverons le voyage idéal et selon TES critères</div>
